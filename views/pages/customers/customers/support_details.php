			...
			<div class="content">
			            ...
			            <div class="row mb-3 mx-1">
			                <div class="col-lg-4 p-0 d-flex">
			                    <div class="p-3 border flex-fill rounded-left border-end-0">
			                        <div class="d-flex align-items-center">
			                            <img class="avatar avatar-lg rounded-circle me-2" alt="img" data-cfsrc="<?= $base_url ?>/assets/img/users/user-08.jpg" style="display:none;visibility:hidden;"><noscript><img src="<?= $base_url ?>/assets/img/users/user-08.jpg" class="avatar avatar-lg rounded-circle me-2" alt="img"></noscript>
			                            <div>
			                    ...
			                    <div class="card">
			                        <div class="card-body">
			                            ...
			                            <div class="d-flex align-items-center justify-content-between border rounded p-2 mb-3">
			                                <div class="d-flex align-items-center">
			                                    <img src="<?= $base_url ?>/assets/img/icons/pdf.svg" alt="img" class="avatar avatar-lg me-2">
			                                    <div>
			                            ...
			                            <div class="d-flex align-items-center justify-content-between border rounded p-2">
			                                <div class="d-flex align-items-center">
			                                    <img alt="img" class="avatar avatar-lg me-2" data-cfsrc="<?= $base_url ?>/assets/img/products/product-01.jpg" style="display:none;visibility:hidden;"><noscript><img src="<?= $base_url ?>/assets/img/products/product-01.jpg" alt="img" class="avatar avatar-lg me-2"></noscript>
			                                    <div>
			    ...
			    <div class="card mb-3">
			        <div class="card-body">
			            <div class="d-flex align-items-center justify-content-between mb-3">
			                <div class="d-flex align-items-center">
			                    <a href="javascript:void(0);"><img class="avatar avatar-lg rounded-circle me-2" alt="img" data-cfsrc="<?= $base_url ?>/assets/img/users/user-03.jpg" style="display:none;visibility:hidden;"><noscript><img src="<?= $base_url ?>/assets/img/users/user-03.jpg" class="avatar avatar-lg rounded-circle me-2" alt="img"></noscript></a>
			                    <div>
			    ...
			    <div class="card mb-3">
			        <div class="card-body">
			            <div class="d-flex align-items-center justify-content-between mb-3">
			                <div class="d-flex align-items-center">
			                    <a href="javascript:void(0);"><img class="avatar avatar-lg rounded-circle me-2" alt="img" data-cfsrc="<?= $base_url ?>/assets/img/users/user-05.jpg" style="display:none;visibility:hidden;"><noscript><img src="<?= $base_url ?>/assets/img/users/user-05.jpg" class="avatar avatar-lg rounded-circle me-2" alt="img"></noscript></a>
			                    <div>
