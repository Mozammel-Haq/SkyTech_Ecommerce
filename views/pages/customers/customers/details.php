			...
			<div class="content content-two">
			    ...
			    <div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
			        <div>
			            <h6><a href="customers.html"><i class="isax isax-arrow-left fs-16 me-2"></i>Customers</a></h6>
			        </div>
			    ...
			    <div class="row">
			        <div class="col-xl-8">
			            ...
			            <div class="card bg-light customer-details-info position-relative overflow-hidden">
			                    ...
			                    <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-3">
			                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
			                            <div class="avatar avatar-xxl rounded-circle flex-shrink-0">
			                                <img alt="user-01" class="img-fluid rounded-circle border border-white border-2" data-cfsrc="<?= $base_url ?>/assets/img/users/user-08.jpg" style="display:none;visibility:hidden;"><noscript><img src="<?= $base_url ?>/assets/img/users/user-08.jpg" alt="user-01" class="img-fluid rounded-circle border border-white border-2"></noscript>
			                            </div>
			                            <div class="">
			                                <p class="text-primary fs-14 fw-medium mb-1">Cl-12345</p>
			                                <h6 class="mb-2"> Robert George <img src="<?= $base_url ?>/assets/img/icons/confirme.svg" alt="confirme" class="ms-1"> </h6>
			                        ...
			                        <div class="card-body border-0 shadow shadow-none">
			                            <ul class="d-flex justify-content-between align-items-center flex-wrap gap-2 p-0 m-0 list-unstyled">
			                                <li>
			                                    ...
			                                    <p> <a href="https://kanakku.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e2888d8a8ca2879a838f928e87cc818d8f">[email&#160;protected]</a> </p>
			                                </li>
			                                <li>
			                ...
			                <img src="<?= $base_url ?>/assets/img/icons/elements-01.svg" alt="elements-01" class="img-fluid customer-details-bg">
			            </div><!-- end card -->
			            <!-- End User -->
			                    ...
			                    <div class="table-responsive table-nowrap">
			                        <table class="table border  m-0">
			                            ...
			                            <tbody>
			                                <tr>
			                                    ...
			                                    <td class="action-item">
			                                        ...
			                                        <ul class="dropdown-menu">
			                                            <li>
			                                                <a href="invoice-details.html" class="dropdown-item d-flex align-items-center"><i class="isax isax-eye me-2"></i>View</a>
			                                            </li>
			                                            <li>
			                                                <a href="edit-invoice.html" class="dropdown-item d-flex align-items-center"><i class="isax isax-edit me-2"></i>Edit</a>
			                                            </li>
			                                            <li>
			                                ...
			                                <tr>
			                                    <td>
			                                        <a href="invoice-details.html" class="link-default">INV00019</a>
			                                    </td>
			                                    <td>02 Dec 2024</td>
			                                ...
			                                <tr>
			                                    <td>
			                                        <a href="invoice-details.html" class="link-default">INV00017</a>
			                                    </td>
			                                    <td>30 Nov 2024</td>
			                                ...
			                                <tr>
			                                    <td>
			                                        <a href="invoice-details.html" class="link-default">INV00012</a>
			                                    </td>
			                                    <td>12 Sep 2025</td>
			                                    <td class="text-dark">$10,000</td>
			                                ...
			                                <tr>
			                                    <td>
			                                        <a href="invoice-details.html" class="link-default">INV00011</a>
			                                    </td>
			                                    <td>10 Aug 2025</td>
			                                    <td class="text-dark">$10,000</td>
			            ...
			            <div class="card">
			                <div class="card-body">
			                    ...
			                    <div class="d-flex align-items-center justify-content-between mb-3">
			                        <div class="d-flex align-items-center">
			                            <a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2">
			                                <img src="<?= $base_url ?>/assets/img/icons/transaction-01.svg" class="rounded-circle" alt="img">
			                            </a>
			                            <div>
			                    ...
			                    <div class="d-flex align-items-center justify-content-between mb-3">
			                        <div class="d-flex align-items-center">
			                            <a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2">
			                                <img src="<?= $base_url ?>/assets/img/icons/transaction-02.svg" class="rounded-circle" alt="img">
			                            </a>
			                            <div>
			                                <h6 class="fs-14 fw-semibold mb-1"><a href="javascript:void(0);">Andrew James</a></h6>
			                                <p class="fs-13"><a href="invoice-details.html" class="link-default">#INV45478</a></p>
