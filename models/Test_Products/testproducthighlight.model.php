...
class TestProductHighlight extends Model implements JsonSerializable
{
	...
	{
		global $db, $tx;
		$db->query("update {$tx}test_product_highlights set product_id='$this->product_id',highlight_text='$this->highlight_text' where id='$this->id'");
	}
	public static function delete($id)
	{
		...
		global $db, $tx;
		$db->query("delete from {$tx}test_product_highlights where id={$productID}");
	}
