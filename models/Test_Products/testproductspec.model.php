...
class TestProductSpec extends Model implements JsonSerializable
{
	...
	{
		global $db, $tx;
		$db->query("update {$tx}test_product_specs set product_id='$this->product_id',spec_text='$this->spec_text' where id='$this->id'");
	}
	public static function delete($id)
	{
		global $db, $tx;
		$db->query("delete from {$tx}test_product_specs where id={$id}");
	}
